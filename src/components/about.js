    ...
    render(){
        return (
            ...
            <div className="resume-section-content">
                ...
                <p className="lead mb-5">I’m currently a manager at a dental office, where I’ve worked for five years, assisting with patient care, appointment scheduling, and insurance policies. While this role isn’t aligned with my long-term goals, it has improved my communication, problem-solving, and interpersonal skills. I hold a Bachelor’s degree in Computer Science and previously, as a software engineer intern, I gained experience with Python and databases, optimizing ETL pipelines. I aim to transition into a software engineer or data scientist role, particularly in healthcare-focused companies.</p>
